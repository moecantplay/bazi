/**
 * The luck-cycle timeline: a vertical rail with one node per luck pillar.
...
/** The pillar's readable name: "yang wood · horse". */
...
/** The element + animal icon pair that anchors a gloss pair. */
...
function CurrentCard({ luck, currentYear }: { luck: LuckPillar; currentYear: number }) {
  ...
  return (
    <div className="card p-4">
      <div className="text-[11px] font-medium text-ink-soft">Current decade</div>
